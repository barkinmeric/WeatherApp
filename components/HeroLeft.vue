<template>
	<section class="bg-gray-900 py-12 px-8 sm:py-16 sm:px-12">
		<div class="mx-auto grid max-w-screen-xl grid-cols-12 grid-rows-1 sm:gap-8">
			<div class="aos-right z-20 col-start-2 col-end-12 row-start-1 my-auto text-center text-white sm:col-start-1 sm:col-end-8">
				<p>
					{{
			...
			<div class="aos-left z-10 col-start-1 col-end-13 row-start-1 mx-auto max-w-sm opacity-20 sm:col-start-8 sm:col-end-13 sm:max-w-xl sm:opacity-100">
